...
window.CODEX_WORLD_GRAPH = [
  ...
  },
  {
    ...
    "lineage": {
      ...
      "last_accepted_change": "AKALYNTH_ASSET_ADD_LANES_V1 — studio 158-image surface mapped to 3488 assets-src files via asset-add-lanes.json"
    },
    "world": {
    ...
    "evidence": [
      ...
      {
        "kind": "verify",
        "ref": "codex/studio/verify/asset-add-lanes.json",
        "note": "Eight studio lanes → assets-src families; 3488 source images mapped"
      }
    ],
    "public_projection": null,
    "tags": [
  ...
  },
  {
    ...
    "summary": "High City map Azura hosts the first player-alive gather → refine → deliver loop behind runtime flags; gate from Rookguard after tutorial completion.",
    "lineage": {
      "origin": "AZURA_LOOP_ALIVE_V1",
      "accepted": true,
      "accepted_at": "2026-06-23T12:00:00Z",
      "last_accepted_change": "AZURA_LOOP_ALIVE_V1 strike — smoke script, gather UX, studio asset lane wiring"
    },
    "world": {
      "description": "Server map Azura (64×64) at spawn (32,32). Four ley-mote nodes, one refinery (Attunement Stand), one curation post. Loop: gather 3s → refine 5s → deliver keystone_token. Gated by CHILL_ZONE_GATHER_ENABLED and CHILL_ZONE_REFINE_ENABLED on beta.",
      "design_refs": [
        "repos/akalynth/.codex/design/chill-zone-refine.md",
        "repos/akalynth/packages/shared/maps/azura.json",
        "repos/akalynth/apps/server/src/world/gather.ts",
        "repos/akalynth/scripts/smoke-beta-azura-loop.mjs",
        "evidence/20260623T114341Z-azura-loop-alive/receipt.json"
      ],
      "implementation": {
        "stage": "beta",
        "slice": "AZURA_LOOP_ALIVE_V1",
        "registry": "repos/akalynth/apps/server/src/world/gather.ts"
      }
    },
    "related": [
      {
        "rel": "part_of",
        "target": "high-city",
        "note": "Azura is the High City chill-zone map reachable via GateToAzura from Rookguard."
      },
      {
        "rel": "references",
        "target": "chill-zone-gather",
        "note": "Mechanic authority for gather/refine/deliver intents and receipts."
      },
      {
        "rel": "connects_to",
        "target": "rookguard",
        "note": "New players clear Rookguard tutorial before gate transfer."
      }
    ],
    "assets": [
      {
        "kind": "tile",
        "path": "codex/studio/tile__gate_to_azura.png"
      },
      {
        "kind": "sprite",
        "path": "codex/studio/item__ley_mote.png"
      },
      {
        "kind": "sprite",
        "path": "codex/studio/item__refined_ley_mote.png"
      },
      {
        "kind": "tile",
        "path": "repos/akalynth/data/assets-built/sprites/tile__gate_to_azura.png"
      },
      {
        "kind": "sprite",
        "path": "repos/akalynth/data/assets-built/sprites/item__ley_mote.png"
      }
    ],
    "packets": [
      {
        "kind": "smoke",
        "ref": "repos/akalynth/scripts/smoke-beta-azura-loop.mjs",
        "status": "open"
      },
      {
        "kind": "evidence",
        "ref": "evidence/20260623T114341Z-azura-loop-alive/receipt.json",
        "status": "accepted"
      }
    ],
    "evidence": [
      {
        "kind": "receipt",
        "ref": "repos/akalynth/docs/engineering-loop/AKALYNTH_ENGINEERING_LOOP_CHILL_ZONE_SHOWCASE_V1/receipt.json"
      },
      {
        "kind": "receipt",
        "ref": "evidence/20260623T114341Z-azura-loop-alive/receipt.json"
      },
      {
        "kind": "verify",
        "ref": "codex/studio/verify/asset-add-lanes.json",
        "note": "lane_terrain tile__gate_to_azura; lane_items ley_mote + refined_ley_mote"
      }
    ],
    "public_projection": null,
    "tags": [
  ...
  },
  {
    ...
    "lineage": {
      ...
      "last_accepted_change": "AZURA_LOOP_ALIVE_V1 — refine extension shipped, beta flags on, live smoke script landed"
    },
    "world": {
    ...
    "related": [
      ...
      {
        "rel": "located_in",
        "target": "azura-chill-zone",
        "note": "First live map placement for gather nodes and stations."
      }
    ],
    "assets": [
      {
      ...
      {
        "kind": "sprite",
        "path": "codex/studio/item__tending_token.png"
      },
      {
        "kind": "sprite",
        "path": "codex/studio/item__keystone_token.png"
      }
    ],
    "evidence": [
      {
  ...
  {
    "schema_version": "codex-entry/v1",
    "id": "akalynth-creature-skeleton-001",
    "type": "creature",
    "title": "Creature Skeleton 001",
    "authority": "Akalynth",
    "author": "guardian@vaultmesh.org",
    "created": "2026-06-23T11:08:00Z",
    "updated": "2026-06-23T12:00:00Z",
    "status": "accepted",
    "visibility": {
      "builder": true,
    ...
    "summary": "Studio behavior-binding export for skeleton guardian archetype; builder permit issued for beta lane, no runtime mutation.",
    "lineage": {
      "origin": "AKALYNTH_CREATURE_SKELETON_001",
      "accepted": true,
      "accepted_at": "2026-06-23T11:08:13Z",
      "last_accepted_change": "studio-export behavior_binding + builder permit 20260623110813"
    },
    "world": {
      "description": "Guardian skeleton with idle/alert states, vision aggro, patrol radius 4, leash 8. Subject asset akalynth_creature_skeleton_001. Codex studio plate creatures__skeleton.png.",
      "design_refs": [
        "codex/studio-exports/wp-68062e43e9aecc21d20d8bc5.json",
        "codex/receipts/AKALYNTH_REVIEW_AKALYNTH_CREATURE_SKELETON_001_20260623110813.json",
        "codex/receipts/AKALYNTH_BUILDER_PERMIT_AKALYNTH_CREATURE_SKELETON_001_20260623110813.json"
      ],
      "implementation": {
        "stage": "spec",
        "slice": "AKALYNTH_CREATURE_SKELETON_001",
        "registry": "codex/studio/akalynth-ledger.js"
      }
    },
    "related": [
      {
        ...
        "note": "Creature codex art lineage from AKALYNTH_ASSET_LIBRARY_V1"
      }
    ],
    "assets": [
      {
        "kind": "sprite",
        "path": "codex/studio/creatures__skeleton.png"
      },
      {
        "kind": "sprite",
        "path": "codex/studio/characters/skeleton_warrior_01.png"
      },
      {
        "kind": "sprite",
        "path": "repos/akalynth/data/assets-built/sprites/creatures__skeleton.png"
      }
    ],
    "packets": [
      {
        "kind": "studio_export",
        "ref": "codex/studio-exports/wp-68062e43e9aecc21d20d8bc5.json",
        "status": "accepted"
      },
      {
        "kind": "builder_permit",
        "ref": "codex/receipts/AKALYNTH_BUILDER_PERMIT_AKALYNTH_CREATURE_SKELETON_001_20260623110813.json",
        "status": "accepted"
      }
    ],
    "evidence": [
      {
        "kind": "receipt",
        "ref": "codex/receipts/AKALYNTH_REVIEW_AKALYNTH_CREATURE_SKELETON_001_20260623110813.json"
      },
      {
        "kind": "receipt",
        "ref": "codex/receipts/AKALYNTH_BUILDER_PERMIT_AKALYNTH_CREATURE_SKELETON_001_20260623110813.json"
      },
      {
        "kind": "verify",
        "ref": "codex/studio/verify/asset-add-lanes.json",
        "note": "lane_creatures creatures__skeleton.png"
      }
    ],
    "public_projection": null,
    "tags": [
  ...
  },
  {
    ...
    "related": [
      ...
      },
      {
        "rel": "contains",
        "target": "azura-chill-zone",
        "note": "Azura map — first player-alive gather/refine/deliver loop on beta."
      },
      {
        "rel": "references",
        "target": "chill-zone-gather",
        "note": "Chill-zone mechanic authority for Azura placements."
      }
    ],
    "assets": [
      {
  ...
  },
  {
    ...
    "lineage": {
      ...
      "last_accepted_change": "AKALYNTH_PLAY_BUILD_GOVERN_SURFACE_V1 PR-12 beta lane publish + PR-13 public projection"
    },
    "world": {
    ...
    "evidence": [
      ...
      {
        "kind": "receipt",
        "ref": "akalynth-ops/evidence/play-build-govern-surface-v1/lane-publish-beta.json"
      }
    ],
    "public_projection": {
      "published": true,
