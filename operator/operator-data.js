...
window.CODEX_FULL = [
  ...
  },
  {
    ...
    "lineage": {
      ...
      "last_accepted_change": "AKALYNTH_PLAY_BUILD_GOVERN_SURFACE_V1 PR-6 builder draft namespace prototype on akalynth main"
    },
    "world": {
    ...
    "evidence": [
      ...
      {
        "kind": "verification",
        "ref": "repos/akalynth/apps/server/tools/verify-builder-draft-namespace-v1.ts"
      },
      {
        "kind": "manifest",
        "ref": "repos/akalynth/packages/shared/builderDraft.ts"
      }
    ],
    "public_projection": {
      "published": false,
